#define NGX_CONFIGURE " --prefix=/usr/local/nginx --user=www --group=www --sbin-path=/usr/sbin/nginx --conf-path=/etc/nginx/nginx.conf --pid-path=/var/run/nginx.pid --lock-path=/var/run/nginx.lock --error-log-path=/opt/logs/nginx/error.log --http-log-path=/opt/logs/nginx/access.log --with-http_ssl_module --with-http_realip_module --with-http_sub_module --with-http_flv_module --with-http_dav_module --with-http_gzip_static_module --with-http_stub_status_module --with-http_addition_module --with-http_spdy_module --with-pcre --with-zlib=../zlib-1.2.11 --add-module=../nginx-http-concat --add-module=../lua-nginx-module --add-module=../ngx_devel_kit"
...
#define NGX_ERROR_LOG_PATH  "/opt/logs/nginx/error.log"
#endif


#ifndef NGX_HTTP_LOG_PATH
#define NGX_HTTP_LOG_PATH  "/opt/logs/nginx/access.log"
#endif
